...
public partial class O2SPopup_User : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Request.Cookies["UserID"] != null)
                    ...
                    ViewState["UserID"] = "";
                if (StaticPool.CheckPermission(ViewState["UserID"].ToString(), "O2SPopup_System_User", "Selects", "KzBMS"))
                {
    ...
    public static string Delete(string id, string userid)
    {
        try
        {
            ...
            if (StaticPool.CheckPermission(userid, "Parking_System_User", "Deletes", "Parking"))
