<%@ Page Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="PrintFileReportTotalMoneyByCardGroup.aspx.cs" Inherits="QLXuatAn_PrintFileReportTotalMoneyByCardGroup" %>
    ...
    <div class="col-xs-12">
        ...
        <div id="Print">
            <asp:Repeater ID="rpt_Card" runat="server">
                <HeaderTemplate>
                    <h2 style="text-align: center"> Tổng hợp thu tiền thẻ lượt theo nhóm thẻ</h2>
