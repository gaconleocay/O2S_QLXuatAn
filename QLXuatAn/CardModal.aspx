<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CardModal.aspx.cs" Inherits="QLXuatAn_CardModal" %>
			                    ...
			                    <tr>
				                    ...
				                    <td id="<%#DataBinder.Eval(Container.DataItem, "CardID")%>">
					                    <div class="hidden-sm hidden-xs btn-group">
                                            <div class="btn-group">
						                        <button class="btn btn-xs btn-info detail" title="Sửa" name="trungaaa" data-toggle="modal" data-target="#modal-form">
    ...
    jQuery(document).ready(function () {
        ...
        $('.detail').click(function (e) {
            ...
            $.ajax({
                ...
                url: 'CardDetailModal.aspx',
                type: 'GET',
                async: false,
                data: { 'Id': id, 'CustomerID': '<%=this.ViewState["CustomerID"].ToString()%>' },
                success: function (data) {
                    $('#' + 'id_carddetailmodal' + '').html(data);
                    $('.preloader').hide();
                    debugger;
        ...
        $("#btnAddCard").click(function (e) {
            ...
            $.ajax({
                ...
                type: 'GET',
                async: false,
                data: { 'Id': '', 'CustomerID': '<%=this.ViewState["CustomerID"].ToString()%>' },
                success: function (data) {
                    $('#' + 'id_carddetailmodal' + '').html(data);
                    $('.preloader').hide();
                    debugger;
        ...
        $('.delete').click(function (e) {
            ...
            if (confirm("Bạn có muốn xóa bản ghi này không?")) {
                AjaxPOST("CardModal.aspx/Delete", '{"id":"' + id + '", "userid":"' + '<%=this.ViewState["UserID"].ToString()%>' + '"}').success(function (result) {
