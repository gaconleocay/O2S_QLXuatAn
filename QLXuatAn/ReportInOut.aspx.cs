...
public partial class QLXuatAn_Report2 : System.Web.UI.Page
{
    ...
    private void BindDataList()
    {
        try
        {
            ...
            var totalCount = 0;
            DataTable dt = ReportService.GetReportInOut_2(KeyWord, UserID, _fromdate, _todate, CardGroupID, LaneID, pageIndex, StaticPool.pagesize, ref totalCount, IsFilterByTimeIn);
            ...
            //        "%')" +
            //        "Union" +
            //        " select * from tblCardEventHistory where IsDelete=0 and EventCode='2' and" +
            //        " DatetimeIn>='" + _fromdate +
            //        "' and DatetimeIn<='" + _todate +
            //        "' and CardGroupID LIKE '" + CardGroupID +
            //        "%' and (LaneIDIn LIKE '%" + LaneID +
            ...
            //        dt.Rows.Add(dr["CardNo"].ToString(),_cardnumber, _plate, _dtimein, _dtimeout, _picIn1, _picIn2, _picOut1, _picOut2, _cardgroupid, _customername, _laneidin, _laneidout, _useridin, _useridout, _moneys, dr["Id"].ToString());
            //    }
            //}
    ...
    protected void Excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string _fromdate = Convert.ToDateTime(dtpFromDate.Value).ToString("yyyy/MM/dd HH:mm:00");
            string _todate = Convert.ToDateTime(dtpToDate.Value).ToString("yyyy/MM/dd HH:mm:59");
            DataTable dt = ReportService.GetReportInOutExcel(KeyWord, UserID, _fromdate, _todate, CardGroupID, LaneID, IsFilterByTimeIn);
            ...
            catch (Exception ex)
            {
                ...
                Response.Redirect("~/QLXuatAn/ReportInOut.aspx", false);
            }
