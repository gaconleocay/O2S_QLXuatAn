<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="SystemConfig.aspx.cs" Inherits="QLXuatAn_SystemConfig" %>
    ...
    <div class="col-xs-12">
        ...
        <form id="frm_UserDetail" class="form-horizontal" runat="server">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Mã số thuế </label>
				<div class="col-sm-9">
					<asp:TextBox id="txtTax" runat="server" class="form-control" placeholder=""/> 
				</div>
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tên biểu phí </label>
				<div class="col-sm-9">
             ...
             <div class="form-group">
				...
				<div class="col-sm-3">
					<asp:TextBox id="txtLogo" runat="server" class="form-control" placeholder=""/> 
				</div>
			</div>
            <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> DelayTime </label>
				<div class="col-sm-3">
					<asp:TextBox id="txtDelayTime" runat="server" class="form-control" placeholder=""/> 
				</div>
			</div>
             <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> P1(MS) </label>
				<div class="col-sm-3">
					<asp:TextBox id="txtPara1" runat="server" class="form-control" placeholder=""/> 
				</div>
			</div>
            <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> P2(KH) </label>
				<div class="col-sm-3">
					<asp:TextBox id="txtPara2" runat="server" class="form-control" placeholder=""/> 
				</div>
			</div>
             <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">  
				    <label class="inline">
				        <input type="checkbox" class="ace" id="chEnableDeleteCardFailed" runat="server"/>
				        <span class="lbl"> Cho phép xóa thẻ lỗi</span>
			        </label>
                </div>
			</div>
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">  
				    <label class="inline">
				        <input type="checkbox" class="ace" id="chEnableSoundAlarm" runat="server"/>
				        <span class="lbl"> Cảnh báo bằng âm thanh</span>
			        </label>
                </div>
			</div>
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">  
				    <label class="inline">
				        <input type="checkbox" class="ace" id="chEnableAlarmMessageBox" runat="server"/>
				        <span class="lbl"> Hiển thị hộp thoại cảnh báo lúc ra</span>
			        </label>
                </div>
			</div>
             <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">  
				    <label class="inline">
				        <input type="checkbox" class="ace" id="chEnableAlarmMessageBoxIn" runat="server"/>
				        <span class="lbl"> Hiển thị hộp thoại cảnh báo lúc vào</span>
			        </label>
                </div>
			</div>
