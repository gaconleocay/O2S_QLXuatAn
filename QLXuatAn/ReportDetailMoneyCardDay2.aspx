<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportDetailMoneyCardDay2.aspx.cs" Inherits="QLXuatAn_ReportDetailMoneyCardDay2" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reportdetailcardday2").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportDetailMoneyCardDay2.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th class="hidden-480">Số HĐ</th>
                                            <th class="hidden-480">Mẫu số</th>
                                            <th class="hidden-480">KH</th>
                                            <th></th>
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td class="hidden-480">
                                     ...
                                     <td class="hidden-480"><%# ((System.Data.DataRowView)Container.DataItem)["PrintIndex"] %></td>
                                     <td class="hidden-480"><%# ((System.Data.DataRowView)Container.DataItem)["Para1"] %></td>
                                     <td class="hidden-480"><%# ((System.Data.DataRowView)Container.DataItem)["Para2"] %></td>
