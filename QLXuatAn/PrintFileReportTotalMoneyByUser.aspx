<%@ Page Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="PrintFileReportTotalMoneyByUser.aspx.cs" Inherits="QLXuatAn_PrintFileReportTotalMoneyByUser" %>
    ...
    <div class="col-xs-12">
        ...
        <div id="Print">
            <asp:Repeater ID="rpt_Card" runat="server">
                <HeaderTemplate>
                    <h2 style="text-align: center"> Tổng hợp thu tiền thẻ lượt theo người dùng</h2>
