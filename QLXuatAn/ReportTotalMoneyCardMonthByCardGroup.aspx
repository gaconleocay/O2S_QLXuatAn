<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportTotalMoneyCardMonthByCardGroup.aspx.cs" Inherits="QLXuatAn_ReportTotalMoneyCardMonth" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reporttotalmoneycardmonth").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportTotalMoneyCardMonthByCardGroup.aspx?' +
            ...
            $('#btnPrintFile').click(function (e) {
                e.preventDefault();
                window.open('PrintFileReportTotalMoneyCardMonthByCardGroup.aspx?' +
                    'CardGroupID=' + document.getElementById("<%= cbCardGroup.ClientID %>").value +
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
                        ...
                        <asp:Repeater id="rpt_Card" runat="server">
                            ...
                            <ItemTemplate>
			                    <tr>
				                    ...
				                    <td><%# ((System.Data.DataRowView)Container.DataItem)["CardGroupName"] %></td>          
