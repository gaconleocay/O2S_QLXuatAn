<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportVehicleInAnyTime.aspx.cs" Inherits="QLXuatAn_ReportVehicleInAnyTime" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reportinbytime").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportVehicleInAnyTime.aspx?' +
            ...
            <div class="widget-body">
				<div class="widget-main">
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Thời điểm </label>
				        <div class="col-sm-2">
