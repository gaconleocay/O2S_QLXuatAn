<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerDetail.aspx.cs" Inherits="QLXuatAn_CustomerDetail" %>
		    ...
		    <div class="tabbable">
			    ...
			    <div class="tab-content">
				    <div id="id_customer_info" class="tab-pane fade in active">	
                        ...
                        <div class="form-group">
				            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Căn </label>
				            <div class="col-sm-5">
