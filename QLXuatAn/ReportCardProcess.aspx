<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportCardProcess.aspx.cs" Inherits="QLXuatAn_ReportCardProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reporcardprocess").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportCardProcess.aspx?' + 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_BreadCrumb" Runat="Server">
    <ul class="breadcrumb">
		...
		<li class="active">Tổng hợp xử lý thẻ</li>
	</ul>
</asp:Content>
                        ...
                        <asp:Repeater id="rpt_Card" runat="server">
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th>Nhóm thẻ</th>
                                            <th>Thêm</th>
                                            <th class="hidden-480">Phát</th> 
                                            <th class="hidden-480">Đổi</th>   
                                            <th class="hidden-480">Trả</th>                                  
                                            <th class="hidden-480">Khóa</th> 
                                            <th class="hidden-480">Mở</th>
                                            <th class="hidden-480">Xóa</th>                                            
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td><%# ((System.Data.DataRowView)Container.DataItem)["ADD"]%></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["RELEASE"]%></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["CHANGE"]%></td> 
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["RETURN"]%></td>  
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["LOCK"]%></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["UNLOCK"]%></td> 
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["DELETE"]%></td>                 
