...
public partial class QLXuatAn_ReportTotalMoneyCardMonth : System.Web.UI.Page
{
    ...
    private void BindDataList()
    {
        try
        {
            ...
            DataTable dtcardgroup = StaticPool.mdb.FillData("select CardGroupName, CardGroupID from tblCardGroup where CardType=0 and CardGroupID LIKE '%" + CardGroupID + "%' order by SortOrder");
    ...
    protected void Excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string _title1 = "Báo cáo thu tiền thẻ tháng theo nhóm thẻ";
            ...
            catch (Exception ex)
            {
                ...
                Response.Redirect("~/QLXuatAn/ReportTotalMoneyCardMonthByCardGroup.aspx", false);
            }
