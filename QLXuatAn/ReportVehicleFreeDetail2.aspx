<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportVehicleFreeDetail2.aspx.cs" Inherits="QLXuatAn_ReportVehicleFreeDetail2" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_report5_2").addClass("active");
            // $(".id_page_report5").addClass("open");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportVehicleFreeDetail2.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
				                            ...
				                            <th class="hidden-480">Số tiền thu</th>
                                            <th class="hidden-480">Số tiền miễn phí</th>
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td class="hidden-480">
                                     ...
                                     <td>
                                         <%# Convert.ToDecimal(((System.Data.DataRowView)Container.DataItem)["Moneys"]).ToString("###,###") %>
                                     </td>
                                     <td><%# Convert.ToDecimal(((System.Data.DataRowView)Container.DataItem)["FreeType"]).ToString("###,###")%></td>		                    
