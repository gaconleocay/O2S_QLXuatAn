<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ControllerDetail.aspx.cs" Inherits="QLXuatAn_ControllerDetail" %>
    ...
    <div class="col-xs-12">
        <form id="frm_UserDetail" class="form-horizontal" runat="server">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label id="Label1" class="col-sm-3 control-label no-padding-right" for="form-field-1"> Địa chỉ (RS232/485/422) </label>
				<div class="col-sm-5">
					<asp:TextBox id="txtAddress" runat="server" class="form-control" Text="" placeholder="0"/>
				</div>
			</div>
            <div class="form-group">
