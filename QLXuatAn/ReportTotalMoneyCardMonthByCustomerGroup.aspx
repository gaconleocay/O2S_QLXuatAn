<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportTotalMoneyCardMonthByCustomerGroup.aspx.cs" Inherits="QLXuatAn_ReportTotalMoneyCardMonthByCustomerGroup" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reporttotalmoneycardmonthbycustomergroup").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportTotalMoneyCardMonthByCustomerGroup.aspx?' +
            ...
            $('#btnPrintFile').click(function (e) {
                e.preventDefault();
                window.open('PrintFileReportTotalMoneyCardMonthByCustomerGroup.aspx?' +
                    'CustomerGroupID=' + document.getElementById("<%= cbCustomerGroup.ClientID %>").value +
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
...
<ul class="breadcrumb">
		...
		<li class="active">Tổng hợp thu tiền thẻ lượt theo nhóm khách hàng</li>
	</ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Content_PageHeader" Runat="Server">
<div class="page-header">
        <h1 id="id_cardlist" runat="server">
	        Tổng hợp thu tiền thẻ lượt theo nhóm khách hàng
        </h1>
    </div>
</asp:Content>
                        ...
                        <asp:Repeater id="rpt_Card" runat="server">
                            ...
                            <ItemTemplate>
			                    <tr>
				                    ...
				                    <td><%# ((System.Data.DataRowView)Container.DataItem)["CustomerGroupName"] %></td>          
