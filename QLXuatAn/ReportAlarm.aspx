<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportAlarm.aspx.cs" Inherits="QLXuatAn_ReportAlarm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reportalarm").addClass("active");
            ...
            $('.delete').click(function (e) {
                ...
                if (confirm("Bạn có muốn xóa bản ghi này không?")) {
                    ...
                    AjaxPOST("ReportAlarm.aspx/Delete", '{"id":"' + id + '", "userid":"' + '<%=this.ViewState["UserID"].ToString()%>' + '"}').success(function (result) {
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportAlarm.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
                   
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
                    '&ToDate=' + document.getElementById("<%= dtpToDate.ClientID %>").value +
                    '&AlarmCode=' + document.getElementById("<%= cbAlarmCode.ClientID %>").value +
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_BreadCrumb" Runat="Server">
    <ul class="breadcrumb">
		...
		<li class="active">Sự kiện cảnh báo</li>
	</ul>
</asp:Content>
            ...
            <div class="widget-body">
				<div class="widget-main">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2 no-padding-left">      
                            <select class="form-control" id="cbAlarmCode" runat = "server">
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th>Cảnh báo</th>
                                            <th>Diễn giải</th>
                                            <th class="hidden-480">Làn đường</th>
                                            <th class="hidden-480">Giám sát</th>                                         
			                    ...
			                    <tr>
                                    ...
                                    <td><%# ((System.Data.DataRowView)Container.DataItem)["Plate"]%></td>
                                     ...
                                     <td class="ace-thumbnails clearfix">
                                        <a href="GetImageFromFile.ashx?FileName=<%#DataBinder.Eval(Container.DataItem, "PicIn1")%>" title="<%#GetDateTime(((System.Data.DataRowView)Container.DataItem)["Date"].ToString())%>" data-rel="colorbox">
										    <img width="25" height="25" alt="25x25" src="GetImageFromFile.ashx?FileName=<%#DataBinder.Eval(Container.DataItem, "PicIn1")%>" />
									    </a>
                                        <a href="GetImageFromFile.ashx?FileName=<%#DataBinder.Eval(Container.DataItem, "PicIn2")%>" title="<%#GetDateTime(((System.Data.DataRowView)Container.DataItem)["Date"].ToString())%>" data-rel="colorbox">
										    <img width="25" height="25" alt="25x25" src="GetImageFromFile.ashx?FileName=<%#DataBinder.Eval(Container.DataItem, "PicIn2")%>" />
									    </a>
                                    </td>
                                   <td><%# GetAlarmName(((System.Data.DataRowView)Container.DataItem)["AlarmCode"].ToString()) %></td>   
                                    <td><%# ((System.Data.DataRowView)Container.DataItem)["Description"]%></td>
                                    <td class="hidden-480"><%#GetLane(((System.Data.DataRowView)Container.DataItem)["LaneID"].ToString())%></td>
