<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportTotalMoneyCardMonthByUser.aspx.cs" Inherits="QLXuatAn_ReportTotalMoneyCardMonthByUser" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reporttotalmoneycardmonthbyuser").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportTotalMoneyCardMonthByUser.aspx?' +
            ...
            $('#btnPrintFile').click(function (e) {
                e.preventDefault();
                window.open('PrintFileReportTotalMoneyCardMonthByUser.aspx?' +
                    'UserID=' + document.getElementById("<%= cbUser.ClientID %>").value +
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
