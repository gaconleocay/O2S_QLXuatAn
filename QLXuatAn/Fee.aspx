<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="Fee.aspx.cs" Inherits="QLXuatAn_Fee" %>
        ...
        jQuery(document).ready(function () {
            ...
            $('.delete').click(function (e) {
                ...
                if (confirm("Bạn có muốn xóa bản ghi này không?")) {
                    ...
                    AjaxPOST("Fee.aspx/Delete", '{"id":"' + id + '", "userid":"' + '<%=this.ViewState["UserID"].ToString()%>' + '"}').success(function (result) {
                ...
                <div class="widget-body">
				    <div class="widget-main">
                        <div class="form-group">
                             ...
                             <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='FeeDetail.aspx'">
                        ...
                        <asp:Repeater id="rpt_Card" runat="server">
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th class="hidden-480">Mức phí</th>
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td><%# ((System.Data.DataRowView)Container.DataItem)["FeeName"]%></td>
                                    <td class="hidden-480">
                                        <%#this.GetCardGroup(((System.Data.DataRowView)Container.DataItem)["CardGroupID"].ToString())%>
				                    </td>
                                    <td class="hidden-480 money"><%#((System.Data.DataRowView)Container.DataItem)["FeeLevel"]%></td>
                                     <td class="hidden-480">
                                        <%#this.GetFeeUnit(((System.Data.DataRowView)Container.DataItem)["Units"].ToString())%>
				                    </td>
                                  
                                                      
				                    <td id="<%# ((System.Data.DataRowView)Container.DataItem)["FeeID"]%>">
					                    <div class="hidden-sm hidden-xs btn-group">
                                            <div class="btn-group">
                                                 <button type="button" class="btn btn-xs btn-info detail" onclick="window.location.href='FeeDetail.aspx?FeeID=<%#DataBinder.Eval(Container.DataItem, "FeeID")%>'">
                                        ...
                                        <div class="hidden-md hidden-lg">
									        <div class="inline pos-rel">
										        ...
										        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											        <li>
												        <a href="FeeDetail.aspx?FeepID=<%#DataBinder.Eval(Container.DataItem, "FeeID")%>" class="tooltip-info" data-rel="tooltip" title="Sửa">
													        <span class="blue">
														        <i class="ace-icon fa fa-pencil bigger-120"></i>
													        </span>
												        </a>
