<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportTotalMoneyByUser.aspx.cs" Inherits="QLXuatAn_ReportTotalMoneyByUser" %>
...
<!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reportbyuser").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportTotalMoneyByUser.aspx?' +
            ...
            $('#btnPrintFile').click(function (e) {
                e.preventDefault();
                window.open('PrintFileReportTotalMoneyByUser.aspx?' +
                    'UserID=' + document.getElementById("<%= cbUser.ClientID %>").value +
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
