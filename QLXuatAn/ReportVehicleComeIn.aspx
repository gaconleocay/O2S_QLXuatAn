<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportVehicleComeIn.aspx.cs" Inherits="QLXuatAn_ReportVehicleComeIn" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reportvehiclecomein").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportVehicleComeIn.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
...
<ul class="breadcrumb">
		...
		<li class="active">Báo cáo xe vào</li>
	</ul>
</asp:Content>
