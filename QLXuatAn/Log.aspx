<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="Log.aspx.cs" Inherits="QLXuatAn_Log" %>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'Log.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
                        ...
                        <asp:Repeater id="rpt_Card" runat="server">
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th class="hidden-480"> Đối tượng </th>   
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["SubSystemCode"]%></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["ObjectName"]%></td> 
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["Actions"]%></td>  
