<%@ Page Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="PrintFileReportTotalMoneyCardMonthByCardGroup.aspx.cs" Inherits="QLXuatAn_PrintFileReportTotalMoneyCardMonthByCardGroup" %>
    ...
    <div class="col-xs-12">
        ...
        <div id="Print">
            <asp:Repeater ID="rpt_Card" runat="server">
                <HeaderTemplate>
                    <h2 style="text-align: center"> Tổng hợp thu tiền thẻ tháng theo nhóm thẻ</h2>
