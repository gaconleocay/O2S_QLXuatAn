<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportTotalMoneyByCardGroup.aspx.cs" Inherits="QLXuatAn_ReportTotalMoneyByCardGroup" %>
 ...
 <!-- JS Global Compulsory -->			
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $(".id_page_reporttotalmoneybycardgroup").addClass("active");
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportTotalMoneyByCardGroup.aspx?' +
            ...
            $('#btnPrintFile').click(function (e) {
                e.preventDefault();
                window.open('PrintFileReportTotalMoneyByCardGroup.aspx?' +
                    'CardGroupID=' + document.getElementById("<%= cbCardGroup.ClientID %>").value +
                    '&FromDate=' + document.getElementById("<%= dtpFromDate.ClientID %>").value +
