...
public partial class ReportInHistory : System.Web.UI.Page
{
    ...
    private void BindDataList()
    {
        try
        {
            ...
            var totalCount = 0;
            DataTable dt = ReportService.GetReportIn_History(KeyWord, IsHaveTime, _fromdate, _todate, CardGroupID, LaneID, UserID, pageIndex, StaticPool.pagesize, ref totalCount);
