<%@ Page Title="" Language="C#" MasterPageFile="~/QLXuatAn/MasterPage.master" AutoEventWireup="true" CodeFile="ReportCustomer.aspx.cs" Inherits="QLXuatAn_ReportCustomer" %>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $('#btnRefresh').click(function (e) {
                e.preventDefault();
                window.location.href = 'ReportCustomer.aspx?KeyWord=' + document.getElementById("<%= txtKeyWord.ClientID %>").value +
                        ...
                        <asp:Repeater id="rpt_Customer" runat="server">
	                            ...
	                            <table class="table table-striped table-bordered table-hover">
		                            <thead>
			                            <tr>
                                            ...
                                            <th class="hidden-480">Ngày ĐKSD</th>
                                            <th class="hidden-480">Ngày Hủy</th>
                            ...
                            <ItemTemplate>
			                    <tr>
                                    ...
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["Vehicle"].ToString() %></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["Plate"].ToString() %></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["ReleaseDate"].ToString() %></td>
                                    <td class="hidden-480"><%#((System.Data.DataRowView)Container.DataItem)["LockDate"].ToString() %></td>
