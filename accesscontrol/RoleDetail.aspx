<%@ Page Title="" Language="C#" MasterPageFile="~/accesscontrol/MasterPage.master" AutoEventWireup="true" CodeFile="RoleDetail.aspx.cs" Inherits="accesscontrol_RoleDetail" %>
                ...
                <div class="tab-content">
				    <div id="id_role_info" class="tab-pane fade in active">	
                        ...
                        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            <asp:TextBox id="txtDescription" runat="server" class="form-control" placeholder="" Text="Kiểm soát vào ra"/>
				            </div>
			            </div>
                        <div class="form-group">
