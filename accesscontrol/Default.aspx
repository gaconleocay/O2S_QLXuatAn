<%@ Page Title="" Language="C#" MasterPageFile="~/accesscontrol/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="accesscontrol_Default" %>
    ...
    <div class="col-xs-12">        
	    ...
	    <div class="infobox infobox-green">
		    <div class="infobox-data">
			    ...
			    <div class="infobox-content">tổng số thẻ</div>
		    </div>
	    </div>
	    ...
	    <div class="infobox infobox-pink">
		    <div class="infobox-data">
			    ...
			    <div class="infobox-content">lượt vào/ra</div>
		    </div>
	    </div>
