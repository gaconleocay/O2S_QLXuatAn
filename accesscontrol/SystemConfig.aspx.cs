...
public partial class accesscontrol_SystemConfig : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Request.Cookies["UserID"] != null)
                    ...
                    ViewState["UserID"] = "";
                if (StaticPool.CheckPermission(ViewState["UserID"].ToString(), "AccessControl_System_SystemConfig", "Selects", "AccessControl"))
                {
    ...
    protected void Save(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (Request.Cookies["UserID"] != null && StaticPool.CheckPermission(Request.Cookies["UserID"].Value.ToString(), "AccessControl_System_SystemConfig", "Updates", "AccessControl"))
                {
                    // Update
